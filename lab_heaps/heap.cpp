...
bool heap<T, Compare>::hasAChild(size_t currentIdx) const
{
    ...
    bool cndtn=leftChild(currentIdx)<_elems.size();
    return cndtn;
}
...
size_t heap<T, Compare>::maxPriorityChild(size_t currentIdx) const
{
    ...
    bool cndtn1=rightChild(currentIdx)>=_elems.size();
    bool cndtn2=higherPriority(_elems[leftChild(currentIdx)],_elems[rightChild(currentIdx)]);
    if(cndtn1||cndtn2){
