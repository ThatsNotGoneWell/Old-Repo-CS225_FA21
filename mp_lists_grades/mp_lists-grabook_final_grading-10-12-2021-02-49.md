...
This report was generated for **zekaiz2** using **422b57d9036bc434bd86d43be898e4e5ebfed09d** (latest commit as of **October 4th 2021, 11:59 pm**)
...
==122== Command: ./test -r xml "List::reverse\ simple"
==122== 
==122== 
==122== HEAP SUMMARY:
==122==     in use at exit: 0 bytes in 0 blocks
==122==   total heap usage: 2,323 allocs, 2,323 frees, 281,212 bytes allocated
==122== 
...
==124==   total heap usage: 2,468 allocs, 2,468 frees, 285,912 bytes allocated
==124== 
...
==132== Command: ./test -r xml "List\ Complex"
==132== 
==132== 
==132== HEAP SUMMARY:
==132==     in use at exit: 0 bytes in 0 blocks
==132==   total heap usage: 2,325 allocs, 2,325 frees, 281,264 bytes allocated
==132== 
