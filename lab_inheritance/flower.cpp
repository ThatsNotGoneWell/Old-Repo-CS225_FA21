...
/*
void Flower::copy(){
    stem=new Rectangle(other.stem->center, other.stem->color,other.stem->width,other.stem->height);
    pistil=new Circle(other.pistil->center, other.pistil->color,other.pistil->radius);
    leaf=new Triangle(other.leaf->color, other.leaf->vertices[0],other.leaf->vertices[1],other.leaf->vertices[2]);
}
